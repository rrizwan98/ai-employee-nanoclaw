...
### Q8: Code Delivery (Required)
```
Where should I deliver your agent code?

1. WhatsApp (ZIP file) - I'll send you a downloadable ZIP
2. GitHub (new repository) - I'll create a new repo for you
3. GitHub (existing repo) - I'll push to your existing repo

Kahan code deliver karoon?

1. WhatsApp (ZIP file) - Download link bhej doon ga
2. GitHub (naya repo) - Naya repository bana doon ga
3. GitHub (existing repo) - Aap ka existing repo mai push kar doon ga
```

**If GitHub selected, ask:**
- For new repo: "What should I name the repository?"
- For existing repo: "What's the repository URL or name (owner/repo)?"
- "Should it be public or private?"

**Maps to:** `delivery.method`, `delivery.github`

### Q9: Frontend/UI (Optional but Recommended)
```
...
Kya aap ko website/UI bhi chahiye agent use karne ke liye?

1. Haan - Poori website with chat
2. Haan - Sirf chat widget (existing site mein add karne ke liye)
3. Nahi - Sirf API (khud frontend banaunga)
```
...
```json
{
  "delivery": {
    ...
    "github": {
      "create_new": false,
      "repo_url": "https://github.com/username/existing-repo",
      "owner": "username",
...
| Delivery not mentioned | `whatsapp` (ZIP file) |
...
🚀 Deploy: [docker/local]
📦 Delivery: [WhatsApp ZIP / GitHub: repo-name]
