...
```
✅ Step 1/7: Agent found: {agent_name}
🔄 Step 2/7: Creating requirements.txt...
```

```
✅ Step 2/7: Dependencies defined
🔄 Step 3/7: Creating .env.example...
```

```
✅ Step 3/7: Environment template created
🔄 Step 4/7: Generating main.py with ChatKit server...
```

```
✅ Step 4/7: Main server file created
🔄 Step 5/7: Creating README.md...
```

```
✅ Step 5/7: Documentation created
🔄 Step 6/7: Saving to local storage...
```

```
✅ Step 6/7: Files saved locally
...
```
❌ Error at Step {n}/7: {error_description}

Common issues:
• Agent not found → Check src/agents/ directory
• Import error → Verify agent factory function name
• API key missing → Add key to .env file

Would you like me to retry or show details?
```
