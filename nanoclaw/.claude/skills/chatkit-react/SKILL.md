...
```
✅ Step 1/6: Project structure verified
🔄 Step 2/6: Installing @openai/chatkit-react...
```

```
✅ Step 2/6: Dependencies installed
🔄 Step 3/6: Creating ChatWidget.tsx component...
```

```
✅ Step 3/6: ChatWidget component created
🔄 Step 4/6: Creating ChatProvider.tsx...
```

```
✅ Step 4/6: ChatProvider created
🔄 Step 5/6: Updating layout.tsx...
```

```
✅ Step 5/6: Layout updated
...
```
❌ Error at Step {n}/6: {error_description}
